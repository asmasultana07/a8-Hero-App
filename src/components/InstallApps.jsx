    ...
    <div className="card flex flex-row justify-between items-end bg-white rounded-xl shadow-md p-4 mt-2" >
                              <div className="sm:flex gap-4">
                                ...
                                <div className="card-body p-2">
                                    <h3 className="text-bb text-lg font-semibold ">title{title} </h3>
                                    <div className="flex gap-3 justify-between items-center">
                                            <p className="bg-[#F1F5E8] text-[#00D390] px-2 py-1 rounded-md flex justify-center items-center gap-2"><LuArrowDownToLine />ad {downloads}</p>
                                            <p className="bg-[#FFF0E1] text-[#FF8811] px-2 py-1 rounded-md flex justify-center items-center gap-2"><LuStar />ra {ratingAvg}  </p>
